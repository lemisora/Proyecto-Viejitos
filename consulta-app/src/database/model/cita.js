...
export default class Citas extends Model {
  ...
  recordatorios = this.collections
    .get("recordatorios")
    .query(Q.where("tipo_tarea", "cita"), Q.where("cita_id", this.id));
  ...
  async actualizarDatos({
    ...
    await this.update((cita) => {
      ...
      if (requierePreparacion !== undefined)
        cita.isRequierePreparacion = requierePreparacion;
      if (notasPreparacion !== undefined)
        cita.notasPreparacion = notasPreparacion;
