...
export default class Recordatorios extends Model {
  ...
  get estaCompletado() {
    return this.estado === ESTADO_RECORDATORIO.COMPLETADO;
  }
  ...
  get colorEstado() {
    switch (this.estado) {
      case ESTADO_RECORDATORIO.PENDIENTE:
        return "#FFA500"; // Naranja
      case ESTADO_RECORDATORIO.COMPLETADO:
        return "#4CAF50"; // Verde
      case ESTADO_RECORDATORIO.OMITIDO:
        return "#9E9E9E"; // Gris
      case ESTADO_RECORDATORIO.POSPUESTO:
        return "#2196F3"; // Azul
      default:
        return "#000000";
    }
